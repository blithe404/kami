...
(function($) {
	...
	$.upload = function(options) {
		...
		// form中增加数据域
		accept_option = '';
		if(opts.accept == 'image') accept_option = ' accept="image/*" capture="camera"';
		var formHtml = '<input type="file" name="' + opts.fileName + '" '+ accept_option +' onchange="onChooseFile(this)">';
