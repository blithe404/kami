...
<div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="menu-nav">
            ...
            <li class="layui-nav-item layui-nav-itemed">
                <a class="" href="javascript:;">充值管理</a>
                <dl class="layui-nav-child">
                    <dd data-url="<?php echo U('PayOrder/index');?>"><a href="javascript:;">充值列表</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item layui-nav-itemed">
                <a class="" href="javascript:;">系统设置</a>
                <dl class="layui-nav-child">
                    <dd data-url="<?php echo U('Img/index');?>"><a href="javascript:;">站点图片</a></dd>
                    <dd data-url="<?php echo U('Conf/index');?>"><a href="javascript:;">系统参数</a></dd>
                </dl>
            </li>
        </ul>
    </div>
